...
int main() {
	...
	// ͼ�����
	std::vector<cv::Mat> i_vPreFrames;		// ͼ��ԭʼ����
	std::vector<cv::Mat> i_processedFrames;	// ͼ����������ݱ���
	std::vector<cv::Mat> i_ntscFrames;		// NTSC
	std::vector<cv::Mat> i_rgbFrames;		// RGB
	std::vector<cv::Mat> i_magnitudeFrames;	// ��������Ƶ֡����ԭʼ����
	std::vector<cv::Mat> i_phaseFrames;		// ��λ����Ƶ֡��������
	int i_iFrameWidth = 0;					// ��Ƶ����
	int i_iFrameHeight = 0;					// ��Ƶ�߶�
	int i_iFrames = 0;						// ��֡��
	int i_dFps = 0;							// ֡��
	cv::Mat i_rgbFrame, i_ntscFrame;		// ��ǰ֡
	// ������Ƶ·��
